package com.example.safaricomtalenthack.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private TokenAuthenticationEntryPoint jwtAuthenticationEntryPoint;
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                ...
                .authorizeRequests().antMatchers("/login","/register","/v2/api-docs","/swagger-ui.html","/health","info").permitAll().
